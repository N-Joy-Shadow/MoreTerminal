...
import njoyshadow.moreterminal.client.gui.me.widget.MTScrollbar;
import njoyshadow.moreterminal.client.gui.me.widget.MTToolboxPanel;
import njoyshadow.moreterminal.client.gui.me.widget.MTUpgradesPanel;
import njoyshadow.moreterminal.client.gui.style.MTBlitter;
import njoyshadow.moreterminal.client.gui.style.MTScreenStyle;
import njoyshadow.moreterminal.client.gui.style.MTTerminalStyle;
...
public class MTMEStorageScreen<C extends MEStorageMenu> extends MTBaseScreen<C> implements ISortSource, IConfigManagerListener {
    ...
    public MTMEStorageScreen(C menu, Inventory playerInventory,
                           Component title, MTScreenStyle style) {
        ...
        if (this.supportsViewCells) {
            ...
            this.widgets.add("viewCells", new MTUpgradesPanel(viewCellSlots, () -> tooltip));
        }
        ...
        this.widgets.add("upgrades", new MTUpgradesPanel(
                menu.getSlots(SlotSemantics.UPGRADE),
                menu.getHost()));
        if (menu.getToolbox().isPresent()) {
            this.widgets.add("toolbox", new MTToolboxPanel(style, menu.getToolbox().getName()));
        }
    }
