...
public class MTUpgradesPanel implements IMTCompositeWidget {
    ...
    public MTUpgradesPanel(List<Slot> slots) {
        this(slots, Collections::emptyList);
    }

    public MTUpgradesPanel(List<Slot> slots, IUpgradeableObject upgradeableObject) {
        this(slots, () -> Upgrades.getTooltipLinesForMachine(upgradeableObject.getUpgrades().getUpgradableItem()));
    }

    public MTUpgradesPanel(List<Slot> slots, Supplier<List<Component>> tooltipSupplier) {
        this.slots = slots;
