...
public class BasicCraftingTermScreen<C extends BasicCraftingTermMenu> extends MEStorageScreen<C> {

    public BasicCraftingTermScreen(C menu, Inventory playerInventory, Component title, ScreenStyle style) {
