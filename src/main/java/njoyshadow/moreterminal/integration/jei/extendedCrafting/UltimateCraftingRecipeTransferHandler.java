...
public  class UltimateCraftingRecipeTransferHandler extends ExtendedCraftingRecipeHandler<UltimateCraftingTerminalContainer> {

    public UltimateCraftingRecipeTransferHandler(Class<UltimateCraftingTerminalContainer> containerClass, IRecipeTransferHandlerHelper helper, int GridSize) {
    ...
    @Override
    protected IRecipeTransferError doTransferRecipe(UltimateCraftingTerminalContainer container, IRecipe<?> recipe,
