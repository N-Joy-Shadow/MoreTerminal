...
public class BasicCraftingRecipeTransferHandler extends ExtendedCraftingRecipeHandler<BasicCraftingTerminalContainer> {

    public BasicCraftingRecipeTransferHandler(Class<BasicCraftingTerminalContainer> containerClass, IRecipeTransferHandlerHelper helper, int GridSize) {
    ...
    @Override
    protected IRecipeTransferError doTransferRecipe(BasicCraftingTerminalContainer container, IRecipe<?> recipe,
