...
public class EliteCraftingRecipeTransferHandler extends ExtendedCraftingRecipeHandler<EliteCraftingTerminalContainer> {

    public EliteCraftingRecipeTransferHandler(Class<EliteCraftingTerminalContainer> containerClass, IRecipeTransferHandlerHelper helper, int GridSize) {
        super(containerClass, helper,GridSize);
    }

    @Override
    protected IRecipeTransferError doTransferRecipe(EliteCraftingTerminalContainer container, IRecipe<?> recipe,
