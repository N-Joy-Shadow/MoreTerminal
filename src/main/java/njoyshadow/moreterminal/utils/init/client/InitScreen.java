...
public class InitScreen {
    ...
    public static void init() {
        ...
        InitScreen.<BasicCraftingTermMenu, BasicCraftingTermScreen<BasicCraftingTermMenu>>register(BasicCraftingTermMenu.TYPE, BasicCraftingTermScreen::new,"/screens/extendedterminals/basic_crafting_terminal.json");
        InitScreen.<AdvancedCraftingTermMenu,AdvancedCraftingTermScreen<AdvancedCraftingTermMenu>>register(AdvancedCraftingTermMenu.TYPE, AdvancedCraftingTermScreen::new,"/screens/extendedterminals/advanced_crafting_terminal.json");
        InitScreen.<EliteCraftingTermMenu,EliteCraftingTermScreen<EliteCraftingTermMenu>>register(EliteCraftingTermMenu.TYPE, EliteCraftingTermScreen::new,"/screens/extendedterminals/elite_crafting_terminal.json");
        InitScreen.<UltimateCraftingTermMenu,UltimateCraftingTermScreen<UltimateCraftingTermMenu>>register(UltimateCraftingTermMenu.TYPE, UltimateCraftingTermScreen::new,"/screens/extendedterminals/ultimate_crafting_terminal.json");
    }
    public static <M extends AEBaseMenu, U extends MTBaseScreen<M>> void register(MenuType<M> type,
                                                                                  StyledScreenFactory<M, U> factory,
                                                                                  String stylePath) {
        MENU_STYLES.put(type, stylePath);
        MenuScreens.<M, U>register(type, (menu, playerInv, title) -> {
            var style = MTStyleManager.loadStyleDoc(stylePath);
    ...
    public interface StyledScreenFactory<T extends AbstractContainerMenu, U extends Screen & MenuAccess<T>> {
        U create(T t, Inventory pi, Component title, MTScreenStyle style);
    }
